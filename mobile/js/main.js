...
window.addEventListener('DOMContentLoaded', function () {
    ...
    // conversion
    var conversionSetAction = new TimelineLite().to('.conversion__content--before-title', 0.6, { opacity: 1, y: 0 }, 0).to('.conversion__content--before-graph', 0.6, { opacity: 1 }, 0.4).to('.conversion__content--before-detail', 0.8, { opacity: 1 }, 0.6).to('.conversion__content--before .conversion__now', 0.6, { opacity: 1 }, 1).to('.conversion__content--before .cover-btn__before', 0.8, { opacity: 1 }, 1.2).to('.conversion__content--before-graph .round.first', 1, { scale: 1 }, 0.8).to('.conversion__content--before-graph .round.second', 1, { scale: 1 }, 1).to('.conversion__content--before-graph .round.third', 1, { scale: 1 }, 1.2).to('.conversion__content--before-graph .round.first span', 0.8, { opacity: 1 }, 1.4).to('.conversion__content--before-graph .round.second span', 0.8, { opacity: 1 }, 1.6).to('.conversion__content--before-graph .round.third span', 0.8, { opacity: 1 }, 1.8);
    ...
    var drugOffset = $('.drug-spec__offset').height() - 50;
    var drugSpecScene = new ScrollMagic.Scene({
    ...
    // meterial
    var meterialAction = new TimelineLite().set('.meterial__panel--title', { opacity: 0, y: 40 }, 0).to('.meterial__panel--title', 0.6, { opacity: 1, y: 0 }, 0.2).to('.meterial__panel--inner-list .round', 0.8, { opacity: 1 }, 0.4).to('.meterial__panel--inner-list .inner-content', 0.8, { opacity: 1 }, 0.8).to('.meterial__panel--inner-detail', 0.6, { opacity: 1 }, 1.2);
    ...
    // gv-1001
    var gv1001Action = new TimelineLite().to('.gv-1001__panel--title', 0.6, { opacity: 1, y: 0 }, 0.2).to('.gv-1001__panel--content-video', 1, { opacity: 1 }, 0.4).to('.gv-1001__panel--content-detail-text', 0.6, { opacity: 1, y: 0 }, 0.6).to('.gv-1001__panel--content-comment .quotation-left', 0.6, { opacity: 1 }, 1).to('.gv-1001__panel--content-comment .quotation-right', 0.6, { opacity: 1 }, 1).to('.gv-1001__panel--content-text', 1, { opacity: 1 }, 1.3).to('.gv-1001__panel--content-comment .border', 0.6, { opacity: 1 }, 1.5).to('.gv-1001__panel--content-copylight', 0.6, { opacity: 1 }, 1.8);
    ...
    // meterial-hope
    var meterialhopeAction = new TimelineLite().to('.meterial-hope__panel--title', 0.6, { opacity: 1, transform: 'translateY(0)' }, 0.2).to('.meterial-hope__panel .solution--title', 0.6, { opacity: 1, y: 0 }, 0.6).to('.meterial-hope__panel--table', 0.8, { opacity: 1 }, 1).to('.meterial-hope__panel .solution--list .solution--item.one', 1, { opacity: 1 }, 1.4).to('.meterial-hope__panel .solution--list .solution--item.two', 1, { opacity: 1 }, 1.8).to('.meterial-hope__panel .solution--list .solution--item.three', 1, { opacity: 1 }, 2.2).to('.meterial-hope__panel .solution--explain', 1, { opacity: 1 }, 2.4);
    ...
    // outro
    var outroAction = new TimelineLite().to('.outro__panel--title', 0.6, { opacity: 1, y: 0 }, 0.2).to('.outro__panel--content-text', 0.6, { opacity: 1, y: 0 }, 0.4).to('.outro__panel--content-strong', 0.8, { opacity: 1 }, 0.6).to('.outro__panel--content-comment .quotation-left', 0.8, { opacity: 1 }, 1.2).to('.outro__panel--content-comment .quotation-right', 0.8, { opacity: 1 }, 1.2).to('.outro__panel--content-comment span', 0.8, { opacity: 1 }, 1.4).to('.outro__panel--content-comment .underline', 0.6, { opacity: 1 }, 1.8).to('.outro__panel--content-person', 1, { opacity: 1 }, 1.8);
